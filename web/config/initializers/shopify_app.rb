...
ShopifyApp.configure do |config|
  ...
  config.application_name = "Yonda | A Sales Tax Solution"
  config.old_secret = ""
  config.scope = ENV.fetch("SCOPES", "read_orders,read_reports,read_products") # See shopify.app.toml for scopes
